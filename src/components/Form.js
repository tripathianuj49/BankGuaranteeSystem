    ...
    <form onSubmit={submitForm}>
      ...
      <div className="container-3">
        <div></div>
              ...
              <div className="item4"><select name="bgtype" id="bgtype"  onChange={handleChange} value={inputs.bgtype}></select></div>
              <div></div>
              <div></div>
              <div></div>
              ...
              <div className="item7"><input type="text" name="receiptdt" id="receiptdt"  onChange={handleChange} value={inputs.receiptdt}/></div>
              <div></div>
              <div></div>
              <div></div>
              ...
              <div className="item24"><input type="text" name="email" id="email"  onChange={handleChange} value={inputs.email}/></div>
              ...
              <div className="item36"><label htmlFor="bgdate">Date</label></div>
              ...
              <div className="item42"><input type="text" name="bgdate" id="bgdate"  onChange={handleChange} value={inputs.bgdate}/></div>
              <div></div>
              <div></div>
              <div></div>
              <div></div>
              ...
              <div className="item44"><input type="text" name="confdate" id="confdate"  onChange={handleChange} value={inputs.confdate}/></div>
              ...
              <div className="item48"><input type="text" name="date" id="date"  onChange={handleChange} value={inputs.date}/></div>
              <div></div>
              <div></div>
              <div></div>
              ...
              <div className="item54"><input type="text" name="validitydt" id="validitydt"  onChange={handleChange} value={inputs.validitydt}/></div>
              <div></div>
              <div className="item55"><label htmlFor="claimdt">Claim Date:</label></div>
              <div className="item56"><input type="text" name="claimdt" id="claimdt"  onChange={handleChange} value={inputs.claimdt}/></div>
              <div></div>
              <div></div>
              <div></div>
              <div></div>
