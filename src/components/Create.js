...
const submitForm=async e =>{
    ...
    try{
      await axios.post("http://localhost:8000/create",inputs)
    ...
    <form onSubmit={submitForm}>
      ...
      <div className="container-3">
        <div></div>
              ...
              <div className="item10"><input type="date" name="clmdon" id="clmdon"  onChange={handleChange} value={inputs.clmdon}/></div>
